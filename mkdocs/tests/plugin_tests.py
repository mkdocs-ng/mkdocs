...
class TestPluginCollection(unittest.TestCase):
    ...
    def test_event_returns_None(self):
        ...
        collection["foo"] = plugin
        self.assertEqual(
            collection.on_nav(["nav item"], config={}, files=[]), ["nav item"]
        )
    ...
    def test_event_empty_item(self):
        ...
        collection["foo"] = plugin
        self.assertEqual(
            collection.on_page_read_source(page=None, config={}), "new source"
        )
    ...
    def test_run_undefined_event_on_collection(self):
        collection = plugins.PluginCollection()
        self.assertEqual(
            collection.on_page_markdown(
                "page markdown", page=None, config={}, files=[]
            ),
            "page markdown",
        )
