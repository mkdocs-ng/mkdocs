...
class TestFiles(PathAssertionMixin, unittest.TestCase):
            ...
            with self.subTest(use_directory_urls=use_directory_urls):
                ...
                if use_directory_urls:
                    ...
                    self.assertPathsEqual(
                        f.abs_dest_path, "/path/to/site/foo/index.html"
                    )
    ...
    def test_md_file_nested(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/bar.md", "/path/to/docs", "/path/to/site", use_directory_urls
                )
                ...
                if use_directory_urls:
                    ...
                    self.assertPathsEqual(
                        f.abs_dest_path, "/path/to/site/foo/bar/index.html"
                    )
    ...
    def test_md_index_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "index.md", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_md_readme_index_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "README.md", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_md_index_file_nested(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/index.md", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_static_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/bar.html", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_media_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/bar.jpg", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_javascript_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/bar.js", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_css_file(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                f = File(
                    "foo/bar.css", "/path/to/docs", "/path/to/site", use_directory_urls
                )
    ...
    def test_file_name_with_custom_dest_uri(self):
        for use_directory_urls in True, False:
            with self.subTest(use_directory_urls=use_directory_urls):
                ...
                self.assertPathsEqual(
                    f.abs_dest_path, "/path/to/site/stuff/1-foo/index.html"
                )
                if use_directory_urls:
    ...
    def test_generated_file_constructor(self, tdir) -> None:
        ...
        for f in [
            ...
            File.generated(
                config, "foo/bar.md", abs_src_path=os.path.join(tdir, "x.md")
            ),
        ]:
            self.assertEqual(f.src_uri, "foo/bar.md")
            self.assertIsNone(f.src_dir)
            self.assertEqual(f.dest_uri, "foo/bar.html")
            self.assertPathsEqual(
                f.abs_dest_path, os.path.abspath("/path/to/site/foo/bar.html")
            )
            self.assertEqual(f.content_string, "вміст")
    ...
    def test_copy_file_from_content(self, dest_dir):
        file = File(
            "test.txt", src_dir="unused", dest_dir=dest_dir, use_directory_urls=False
        )
