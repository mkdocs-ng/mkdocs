...
* Add a continuous benchmarking suite (`benchmarks/`, `hatch run bench:test`) run under [CodSpeed](https://codspeed.io) in CI, establishing a performance baseline for build-pipeline optimization work. #87
